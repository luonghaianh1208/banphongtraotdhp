...
export const TaskConfigProvider = ({ children }) => {
  ...
  const value = useMemo(() => ({
    ...
    getPriorityById,
    getPenaltyTypeById,
  }), [categories, priorities, penaltyTypes, loading, getCategoryById, getPriorityById, getPenaltyTypeById]);
