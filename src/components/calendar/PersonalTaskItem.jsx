import { MdCheckCircle, MdDelete, MdAccessTime, MdCheckBox, MdCheckBoxOutlineBlank } from 'react-icons/md';

const PersonalTaskItem = ({ task, onToggle, onDelete }) => (
  <div className={`flex items-start gap-2 px-2 py-1.5 rounded-lg group transition-all ${task.done ? 'opacity-50' : ''} hover:bg-sky-50 dark:hover:bg-sky-950/20`}>
    <button onClick={() => onToggle(task.id, task.done)} className="mt-0.5 shrink-0 text-sky-500">
